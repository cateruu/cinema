  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='z-50 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-slate-950 rounded-xl p-3 whitespace-nowrap shadow-xl'>
          <Dialog.Title className='flex items-center gap-2 text-xl font-medium text-slate-500'>
            <Clapperboard size={20} />
            Delete movie
          </Dialog.Title>
          <Dialog.Description className='mt-3 font-medium'>
